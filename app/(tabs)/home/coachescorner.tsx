...
const coaches: Coach[] = [
  ...
  },
  {
    ...
    description:
      "Rowan McDonnell plays for USA's National Team and has dedicated himself to expanding ultimate's reach through coaching youth programs, leading international clinics across Europe, Asia, Africa, and the Americas, and creating accessible training systems through Excel Ultimate. A global ambassador for the sport, he bridges cultures and continents through the game. His commitment to teaching, innovation, and community building has made him one of the hardest working figures advancing ultimate today. He's thrilled to move to Portland, Maine in September for his first Lobster Pot.",
  },
  {
    name: 'Jared Jandreau',
  ...
  },
  {
    ...
    description:
      'Chuck Cleary is a videographer and content creator at CF Films, specializing in capturing ultimate frisbee gameplay and creating compelling sports content. His work helps teams analyze their performance and share their stories with the community.',
  },
  {
    name: 'Bill Bourret',
    ...
    description:
      "Bill is an observer from Chapel Hill, North Carolina with ten years of experience. Lobster Pot will be his 20th tournament of 2025, and he's thrilled to attend such an extraordinary event. In his free time, he enjoys biking, scootering, watching hockey (Go Canes), and playfully challenging fellow observers with obscure rules questions (what happens if a disc hits a bird?!). See you in October!",
  },
  {
    name: 'Keith Raynor',
  ...
  },
  {
    ...
    description:
      'Nathan Wicks played for Yale Superfly (college), Snapple, and Death-or-Glory (club national champion in 1999, world champion in 1999 and 2000). He coached Brown University to college national championships in 2000 and 2005, and has coached Death-or-Glory, Ironside, DiG, and Scoop in open division. Coached Glory (2023-2025) and also coached YCCs from 2019-2023.',
  },
];
