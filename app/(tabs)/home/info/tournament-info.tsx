    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <CustomText allowFontScaling maxFontSizeMultiplier={1.3} style={styles.content}>
          ...
          <Link
            href={'https://www.southportland.gov/Facilities/Facility/Details/Wainwright-Recreation-Complex-35'}
            allowFontScaling
            maxFontSizeMultiplier={1.3}
            style={styles.linkRed}>
            Wainwright Complex
          </Link>
          , which is located at 125 Gary Maietta Way in South Portland Maine. The Wainwright Complex has over 66 acres
          of developed athletic fields. Ultimate tournaments are hosted here every year by Maine Ultimate, the local
          organization, from hat leagues to regional Club events. Wainwright also plays host to the Greenbelt Walkway
          ...
          <Link
            ...
            href={'https://www.foodandwine.com/global-tastemakers-best-united-states-cities-food-drink-2024-8620202'}
            style={styles.link}>
            Food & Wine
          </Link>{' '}
