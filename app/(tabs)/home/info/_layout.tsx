  ...
  return (
    <Stack>
      ...
      <Stack.Screen
        ...
        options={{ header: () => <CustomHeader title="Tournament Info" /> }}
      />
      ...
      <Stack.Screen
        name="wainwright"
        options={{ header: () => <CustomHeader title="Wainwright Facility" /> }}
      />
      <Stack.Screen
        name="refund-policy"
        options={{ header: () => <CustomHeader title="Refund Policy" /> }}
      />
      <Stack.Screen
        name="restaurants-hotels"
        options={{
          header: () => <CustomHeader title="Restaurants & Hotels" />,
        }}
      />
      ...
      <Stack.Screen
        name="feedback"
        options={{ header: () => <CustomHeader title="Requests / Feedback" /> }}
      />
