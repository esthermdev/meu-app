...
export type ProfileRoleRow = Database['public']['Tables']['profile_roles']['Row'];
...
export type SpiritScoreRow = Database['public']['Tables']['spirit_scores']['Row'];
export type SpiritScoreInsert = Database['public']['Tables']['spirit_scores']['Insert'];
export type TeamRow = Database['public']['Tables']['teams']['Row'];
export type TeamSpiritRankingRow = Database['public']['Views']['team_spirit_rankings']['Row'];
